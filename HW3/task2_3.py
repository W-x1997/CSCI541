...
sc = SparkContext(master='local[*]', appName='weixin_HW3_task2_3')
...
input_file_train=input_file_path+"/yelp_train.csv"
#nput_file_test="./data/yelp_val.csv"
#output_file="./task2_2.csv"
business_path=input_file_path+"/business.json"
photo_path=input_file_path+"/photo.json"
